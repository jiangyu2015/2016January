			...
			newLang:function(){
				$.validationEngineLanguage.allRules = {
                    ...
                    "usernameFunction": {
                        ...
                        "alertText": "* 6~15个字符，可包含中文、数字、字母和下划线，并且不能以下划线开头"
                    },
					"ajaxUsername":{
						url: window.qjw.ctx + "/ajaxSupport/validUsername.json",
						alertText: "* 用户名已被使用",
						alertTextLoad: "正在验证中..."
					},
					"ajaxMobile":{
						url: window.qjw.ctx + "/ajaxSupport/validMobile.json",
						alertText: "手机号已被使用",
						alertTextLoad: "正在验证中..."
					}
