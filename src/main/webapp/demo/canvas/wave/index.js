...
(this, function () {
    ...
    var p = {
        ...
        strokeStyle: "rgba(10, 10, 100, 0.5)",
        type: "Sine"
    };
    return a.prototype.getDimension = function (a) {
        ...
        for (c = 0; c < this.waveWidth; c += b.segmentLength)
            d = this.getPoint(a, c, b), this.ctx.lineTo(d.x, d.y), d = void 0;
    ...
    var a = new SineWaves({
        ...
        resizeEvent: function () {
            ...
            for (var i = 0; i < 3; i++) {
                ...
                colors[i].addColorStop(.5, getRgba(rgba[i][1]));
                colors[i].addColorStop(1, getRgba(rgba[i][2]));
            }
            for (var b = -1, c = this.waves.length; ++b < c;)
                this.waves[b].strokeStyle = colors[b];
